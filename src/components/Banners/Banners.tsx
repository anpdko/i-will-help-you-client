	...
	return (
      <div className='container'>
         <div className={s.banners}>
            <Bunner
               img="http://localhost:8080/static/images/banners/banner-1.png"
            ...
            />
            <Bunner
               img="http://localhost:8080/static/images/banners/banner-2.png"
            ...
            />
            <Bunner
               img="http://localhost:8080/static/images/banners/banner-3.png"
