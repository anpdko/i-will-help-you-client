    ...
    translations: [
      {
        ...
        job: 'Volunteer',
        title: 'Together, Building a Brighter Future',
        body: 'As we look ahead, our commitment remains steadfast—to be a beacon of hope for those who seek solace, an advocate for those who yearn to grow, and a guiding light for those who dream of a world beyond the war.',
      },
      {
        language: 'ua',
        name: 'Юлія Ткаченко',
        job: 'Волонтер',
        title: 'Разом будуємо світле майбутнє',
        body: 'Дивлячись у майбутнє, ми залишаємося непохитними у своєму прагненні бути маяком надії для тих, хто шукає розради, захисником для тих, хто прагне зростання, і дороговказом для тих, хто мріє про світ без війн.',
      },
    ],
    photo: 'review-2.png',
  },
